...
namespace PLE::algorithm
{
    ...
    namespace natives
    {
        ...
        cell AMX_NATIVE_CALL ibsearch(AMX* amx, cell* params)
        {
        ...
        cell AMX_NATIVE_CALL fbsearch(AMX* amx, cell* params)
        {
        ...
        cell AMX_NATIVE_CALL sbsearch(AMX* amx, cell* params)
        {
        ...
        cell AMX_NATIVE_CALL all_of(AMX* amx, cell* params)
        {
            ...
            const PLE::functional::function fid(func);
        ...
        cell AMX_NATIVE_CALL any_of(AMX* amx, cell* params)
        {
        ...
        cell AMX_NATIVE_CALL none_of(AMX* amx, cell* params)
        {
        ...
        cell AMX_NATIVE_CALL for_each(AMX* amx, cell* params)
        {
        ...
        cell AMX_NATIVE_CALL find(AMX* amx, cell* params)
        {
        ...
        cell AMX_NATIVE_CALL find_if(AMX* amx, cell* params)
        {
        ...
        cell AMX_NATIVE_CALL find_if_not(AMX* amx, cell* params)
        {
        ...
        cell AMX_NATIVE_CALL find_end(AMX* amx, cell* params)
        {
        ...
        cell AMX_NATIVE_CALL find_first_of(AMX* amx, cell* params)
        {
        ...
        cell AMX_NATIVE_CALL adjacent_find(AMX* amx, cell* params)
        {
        ...
        cell AMX_NATIVE_CALL count_if(AMX* amx, cell* params)
        {
        ...
        cell AMX_NATIVE_CALL mismatch(AMX* amx, cell* params)
        {
        ...
        cell AMX_NATIVE_CALL is_permutation(AMX* amx, cell* params)
        {
        ...
        cell AMX_NATIVE_CALL search(AMX* amx, cell* params)
        {
        ...
        cell AMX_NATIVE_CALL search_n(AMX* amx, cell* params)
        {
        ...
        cell AMX_NATIVE_CALL copy(AMX* amx, cell* params)
        {
        ...
        cell AMX_NATIVE_CALL copy_if(AMX* amx, cell* params)
        {
        ...
        cell AMX_NATIVE_CALL copy_backward(AMX* amx, cell* params)
        {
        ...
        cell AMX_NATIVE_CALL swap(AMX* amx, cell* params)
        {
        ...
        cell AMX_NATIVE_CALL swap_ranges(AMX* amx, cell* params)
        {
        ...
        cell AMX_NATIVE_CALL transform(AMX* amx, cell* params)
        {
        ...
        cell AMX_NATIVE_CALL transform2(AMX* amx, cell* params)
        {
        ...
        cell AMX_NATIVE_CALL replace(AMX* amx, cell* params)
        {
        ...
        cell AMX_NATIVE_CALL replace_if(AMX* amx, cell* params)
        {
        ...
        cell AMX_NATIVE_CALL replace_copy(AMX* amx, cell* params)
        {
        ...
        cell AMX_NATIVE_CALL replace_copy_if(AMX* amx, cell* params)
        {
        ...
        cell AMX_NATIVE_CALL generate(AMX* amx, cell* params)
        {
        ...
        cell AMX_NATIVE_CALL remove(AMX* amx, cell* params)
        {
        ...
        cell AMX_NATIVE_CALL remove_if(AMX* amx, cell* params)
        {
        ...
        cell AMX_NATIVE_CALL remove_copy(AMX* amx, cell* params)
        {
        ...
        cell AMX_NATIVE_CALL remove_copy_if(AMX* amx, cell* params)
        {
        ...
        cell AMX_NATIVE_CALL unique(AMX* amx, cell* params)
        {
        ...
        cell AMX_NATIVE_CALL unique_copy(AMX* amx, cell* params)
        {
        ...
        cell AMX_NATIVE_CALL reverse(AMX* amx, cell* params)
        {
        ...
        cell AMX_NATIVE_CALL reverse_copy(AMX* amx, cell* params)
        {
        ...
        cell AMX_NATIVE_CALL rotate(AMX* amx, cell* params)
        {
        ...
        cell AMX_NATIVE_CALL rotate_copy(AMX* amx, cell* params)
        {
        ...
        cell AMX_NATIVE_CALL shuffle(AMX* amx, cell* params)
        {
            ...
            std::shuffle(start, end, mt19937);
            return true;
        }
        //native sample(range[], numcells, dest[], count);
        cell AMX_NATIVE_CALL sample(AMX* amx, cell* params)
        {
            ...
            return std::sample(start, end, dest, params[4], mt19937) - dest;
        }

        //native bool:is_partitioned(range[], numcells, {func_bool1, func_cell1, _}:func[FTSIZE]);
        cell AMX_NATIVE_CALL is_partitioned(AMX* amx, cell* params)
        {
        ...
        cell AMX_NATIVE_CALL partition(AMX* amx, cell* params)
        {
        ...
        cell AMX_NATIVE_CALL stable_partition(AMX* amx, cell* params)
        {
        ...
        cell AMX_NATIVE_CALL partition_copy(AMX* amx, cell* params)
        {
        ...
        cell AMX_NATIVE_CALL partition_point(AMX* amx, cell* params)
        {
        ...
        cell AMX_NATIVE_CALL sort(AMX* amx, cell* params)
        {
            ...
            std::sort(start, end, [&amx, &fid](cell x, cell y) { logprintf("%d %d\n", x, y);  return ExecuteFunctionC2(amx, fid, x, y); });
            return true;
        }
        //native noret:sort(range[], middle, end, {func_bool2, func_cell2, _}:func[FTSIZE] = fixed_functions::less);
        cell AMX_NATIVE_CALL partial_sort(AMX* amx, cell* params)
        {
        ...
        cell AMX_NATIVE_CALL partial_sort_copy(AMX* amx, cell* params)
        {
        ...
        cell AMX_NATIVE_CALL is_sorted(AMX* amx, cell* params)
        {
        ...
        cell AMX_NATIVE_CALL nth_element(AMX* amx, cell* params)
        {
        ...
        cell AMX_NATIVE_CALL lower_bound(AMX* amx, cell* params)
        {
        ...
        cell AMX_NATIVE_CALL upper_bound(AMX* amx, cell* params)
        {
        ...
        cell AMX_NATIVE_CALL equal_range(AMX* amx, cell* params)
        {
        ...
        cell AMX_NATIVE_CALL binary_search(AMX* amx, cell* params)
        {
        ...
        cell AMX_NATIVE_CALL merge(AMX* amx, cell* params)
        {
        ...
        cell AMX_NATIVE_CALL inplace_merge(AMX* amx, cell* params)
        {
        ...
        cell AMX_NATIVE_CALL includes(AMX* amx, cell* params)
        {
        ...
        cell AMX_NATIVE_CALL set_union(AMX* amx, cell* params)
        {
        ...
        cell AMX_NATIVE_CALL set_intersection(AMX* amx, cell* params)
        {
        ...
        cell AMX_NATIVE_CALL set_difference(AMX* amx, cell* params)
        {
        ...
        cell AMX_NATIVE_CALL set_symmetric_difference(AMX* amx, cell* params)
        {
        ...
        //native bool:is_heap(range[], numcells, {func_bool2, func_cell2, _}:func[FTSIZE] = fixed_functions::less);
        cell AMX_NATIVE_CALL is_heap(AMX* amx, cell* params)
        {
            error_if(!check_params(3), "[PLE] algorithm>> is_heap: expected 3 parameters but found %d parameters.", get_params_count());

            cell* start = NULL;
            amx_GetAddr(amx, params[1], &start);
            cell* end = start + params[2];
            error_if(end < start, "[PLE] algorithm>> is_heap: 'numcells' parameter (%d) below zero", params[2]);

            cell* func = NULL;
            amx_GetAddr(amx, params[5], &func);
            const PLE::functional::function fid(func);
            error_if(!fid.IsValidFunctionID(2), "[PLE] algorithm>> is_heap: function object 'func' is not valid");

            return std::is_heap(start, end, [&amx, &fid](cell x, cell y) { return ExecuteFunctionC2(amx, fid, x, y); });
        }
        //native is_heap_until(range[], numcells, {func_bool2, func_cell2, _}:func[FTSIZE] = fixed_functions::less);
        cell AMX_NATIVE_CALL is_heap_until(AMX* amx, cell* params)
        {
            error_if(!check_params(3), "[PLE] algorithm>> is_heap_until: expected 3 parameters but found %d parameters.", get_params_count());

            cell* start = NULL;
            amx_GetAddr(amx, params[1], &start);
            cell* end = start + params[2];
            error_if(end < start, "[PLE] algorithm>> is_heap_until: 'numcells' parameter (%d) below zero", params[2]);

            cell* func = NULL;
            amx_GetAddr(amx, params[5], &func);
            const PLE::functional::function fid(func);
            error_if(!fid.IsValidFunctionID(2), "[PLE] algorithm>> is_heap_until: function object 'func' is not valid");

            return std::is_heap_until(start, end, [&amx, &fid](cell x, cell y) { return ExecuteFunctionC2(amx, fid, x, y); }) - start;
        }
        //native noret:make_heap(range[], numcells, {func_bool2, func_cell2, _}:func[FTSIZE] = fixed_functions::less);
        cell AMX_NATIVE_CALL make_heap(AMX* amx, cell* params)
        {
            error_if(!check_params(3), "[PLE] algorithm>> make_heap: expected 3 parameters but found %d parameters.", get_params_count());

            cell* start = NULL;
            amx_GetAddr(amx, params[1], &start);
            cell* end = start + params[2];
            error_if(end < start, "[PLE] algorithm>> make_heap: 'numcells' parameter (%d) below zero", params[2]);

            cell* func = NULL;
            amx_GetAddr(amx, params[5], &func);
            const PLE::functional::function fid(func);
            error_if(!fid.IsValidFunctionID(2), "[PLE] algorithm>> make_heap: function object 'func' is not valid");

            std::make_heap(start, end, [&amx, &fid](cell x, cell y) { return ExecuteFunctionC2(amx, fid, x, y); });
            return 0;
        }
        //native noret:sort_heap(range[], numcells, {func_bool2, func_cell2, _}:func[FTSIZE] = fixed_functions::less);
        cell AMX_NATIVE_CALL sort_heap(AMX* amx, cell* params)
        {
            error_if(!check_params(3), "[PLE] algorithm>> sort_heap: expected 3 parameters but found %d parameters.", get_params_count());

            cell* start = NULL;
            amx_GetAddr(amx, params[1], &start);
            cell* end = start + params[2];
            error_if(end < start, "[PLE] algorithm>> sort_heap: 'numcells' parameter (%d) below zero", params[2]);

            cell* func = NULL;
            amx_GetAddr(amx, params[5], &func);
            const PLE::functional::function fid(func);
            error_if(!fid.IsValidFunctionID(2), "[PLE] algorithm>> sort_heap: function object 'func' is not valid");

            std::sort_heap(start, end, [&amx, &fid](cell x, cell y) { return ExecuteFunctionC2(amx, fid, x, y); });
            return 0;
        }
        //native noret:push_heap(range[], numcells, {func_bool2, func_cell2, _}:func[FTSIZE] = fixed_functions::less);
        cell AMX_NATIVE_CALL push_heap(AMX* amx, cell* params)
        {
            error_if(!check_params(3), "[PLE] algorithm>> push_heap: expected 3 parameters but found %d parameters.", get_params_count());

            cell* start = NULL;
            amx_GetAddr(amx, params[1], &start);
            cell* end = start + params[2];
            error_if(end < start, "[PLE] algorithm>> push_heap: 'numcells' parameter (%d) below zero", params[2]);

            cell* func = NULL;
            amx_GetAddr(amx, params[5], &func);
            const PLE::functional::function fid(func);
            error_if(!fid.IsValidFunctionID(2), "[PLE] algorithm>> push_heap: function object 'func' is not valid");

            std::push_heap(start, end, [&amx, &fid](cell x, cell y) { return ExecuteFunctionC2(amx, fid, x, y); });
            return 0;
        }
        //native noret:pop_heap(range[], numcells, {func_bool2, func_cell2, _}:func[FTSIZE] = fixed_functions::less);
        cell AMX_NATIVE_CALL pop_heap(AMX* amx, cell* params)
        {
            error_if(!check_params(3), "[PLE] algorithm>> pop_heap: expected 3 parameters but found %d parameters.", get_params_count());

            cell* start = NULL;
            amx_GetAddr(amx, params[1], &start);
            cell* end = start + params[2];
            error_if(end < start, "[PLE] algorithm>> pop_heap: 'numcells' parameter (%d) below zero", params[2]);

            cell* func = NULL;
            amx_GetAddr(amx, params[5], &func);
            const PLE::functional::function fid(func);
            error_if(!fid.IsValidFunctionID(2), "[PLE] algorithm>> pop_heap: function object 'func' is not valid");

            std::pop_heap(start, end, [&amx, &fid](cell x, cell y) { return ExecuteFunctionC2(amx, fid, x, y); });
            return 0;
        }
        ...
        cell AMX_NATIVE_CALL minmax_element(AMX* amx, cell* params)
        {
        ...
        cell AMX_NATIVE_CALL min_element(AMX* amx, cell* params)
        {
        ...
        cell AMX_NATIVE_CALL max_element(AMX* amx, cell* params)
        {
        ...
        cell AMX_NATIVE_CALL lexicographical_compare(AMX* amx, cell* params)
        {
        ...
        cell AMX_NATIVE_CALL next_permutation(AMX* amx, cell* params)
        {
        ...
        cell AMX_NATIVE_CALL prev_permutation(AMX* amx, cell* params)
        {
        ...
        cell AMX_NATIVE_CALL iota(AMX *amx, cell params[])
        {
            cell* start = NULL;
            amx_GetAddr(amx, params[1], &start);
        ...
        cell AMX_NATIVE_CALL accumulate(AMX *amx, cell params[])
        {
            cell* start = NULL;
            amx_GetAddr(amx, params[1], &start);
        ...
        cell AMX_NATIVE_CALL inner_product(AMX *amx, cell params[])
        {
            cell* start1 = NULL;
            amx_GetAddr(amx, params[1], &start1);
            ...
            const PLE::functional::function fid1(func1);

            cell* func2 = NULL;
            amx_GetAddr(amx, params[6], &func2);
            const PLE::functional::function fid2(func2);
        ...
        cell AMX_NATIVE_CALL adjacent_difference(AMX *amx, cell params[])
        {
            cell* start1 = NULL;
            amx_GetAddr(amx, params[1], &start1);
        ...
        cell AMX_NATIVE_CALL partial_sum(AMX *amx, cell params[])
        {
            cell* start1 = NULL;
            amx_GetAddr(amx, params[1], &start1);
        ...
        //native gcd(x, y);
        cell AMX_NATIVE_CALL gcd(AMX *amx, cell params[])
        {
        ...
        //native lcm(x, y);
        cell AMX_NATIVE_CALL lcm(AMX *amx, cell params[])
        {
            std::function<cell(cell, cell)> gcd = [&](cell x, cell y)
            {
                if (x < y) return gcd(y, x);
